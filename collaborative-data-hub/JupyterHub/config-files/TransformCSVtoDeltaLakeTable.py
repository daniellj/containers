...
# check environment variables: SPARK_HOME
get_ipython().system('export SPARK_HOME=/opt/apache-spark')
environ["SPARK_HOME"] = '/opt/apache-spark'
get_ipython().system('echo "- SPARK_HOME:$SPARK_HOME"')
...
get_ipython().system('export PATH=$PATH:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/jdk:/opt/jdk/bin:/opt/apache-spark:/opt/apache-spark/bin:/opt/apache-spark/sbin')
environ["PATH"] = "/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/jdk:/opt/jdk/bin:/opt/apache-spark:/opt/apache-spark/bin:/opt/apache-spark/sbin"
...
print('pyspark version:', s_context_dl.version)
print('java spark version:', s_context_dl._jsc.version())
print(f'hadoop version = {s_context_dl._jvm.org.apache.hadoop.util.VersionInfo.getVersion()}')
...
# ### Write data - Delta Lake

# In[14]:


data_dl.write.format("delta").save("hdfs://hdpmaster:9000/deltalake/teste2_tb.delta", mode='ignore')


# ### Read data - Delta Lake

# In[15]:


df_dl = s_session_delta.read.format("delta").load("hdfs://hdpmaster:9000/deltalake/teste2_tb.delta")
df_dl.show(10)
